...
Life::Life(float x, float y, float z, color_t color, color_t color1) {
...
void Life::draw(glm::mat4 VP, long long lives) {
    Matrices.model = glm::mat4(1.0f);
    glm::mat4 translate = glm::translate (this->position);    // glTranslatef
    glm::mat4 rotate    = glm::rotate((float) (this->rotation * M_PI / 180.0f), glm::vec3(1, 0, 0));
    glm::mat4 rotatelol   = glm::rotate((float) (this->rotation_y * M_PI / 180.0f), glm::vec3(0, 1, 0));
    glm::mat4 rotatey    = glm::rotate((float)(lives/40.0f * -M_PI), glm::vec3(0, 1, 0)) ;
    ...
    Matrices.model *= (rotatelol * rotatey);
